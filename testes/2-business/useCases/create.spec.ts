...
import { FoneEntity } from '../../../src/1-domain/fone'
...
describe('Test Suite for use case create pessoa', () => {
    ...
    test('should create a person contact', async () => {
        const spy = jest.spyOn(repositoriesPessoa, 'create').mockReturnValue(
            Promise.resolve(PessoaEntity.create({ nome: 'test', sobrenome: 'unitario' }))
        );
    ...
    test('should handle exception when repository create method throws', async () => {
        jest.spyOn(repositoriesPessoa, 'create').mockRejectedValue(new CustomError('Some error message'));
...
describe('Test Suite for use case findOne pessoa', () => {
    ...
    test('should find a person entity ', async () => {
        const spy = jest.spyOn(repositoriesPessoa, 'findOne').mockReturnValue(
            Promise.resolve(PessoaEntity.create({ nome: 'test', sobrenome: 'unitario' }))
        );
    ...
    test('should handle exception when repository findOne method throws', async () => {
        jest.spyOn(repositoriesPessoa, 'findOne').mockRejectedValue(new CustomError('Some error message'));
...
describe('Test Suite for use case findName pessoa', () => {
    ...
    test('should create a person entity ', async () => {
        const spy = jest.spyOn(repositoriesPessoa, 'findName').mockReturnValue(
            Promise.resolve([PessoaEntity.create({ nome: 'test', sobrenome: 'unitario' })])
        );
    ...
    test('should handle exception when repository findName method throws', async () => {
        jest.spyOn(repositoriesPessoa, 'findName').mockRejectedValue(new CustomError('Some error message'));
...
describe('Test Suite for use case findAll pessoa', () => {
    ...
    test('should handle exception when repository find all method throws', async () => {
        jest.spyOn(repositoriesPessoa, 'findAll').mockRejectedValue(new CustomError('Some error message'));
...
describe('Test Suite for use case create pessoa', () => {
    ...
    test('should update a person contact and if existe fone update fone', async () => {
        jest.spyOn(repositoriesPessoa, 'findOne').mockReturnValue(
            Promise.resolve(PessoaEntity.create({ nome: 'test', sobrenome: 'unitario', fone: { celular: true, codigo: '88', numero: '999151386' } }))
        );
        const spyUpdatePessoa = jest.spyOn(repositoriesPessoa, 'update').mockReturnValue(
            Promise.resolve(PessoaEntity.create({ nome: 'test', sobrenome: 'unitario', fone: { celular: true, codigo: '88', numero: '999151386' } }))
        );

        const spyUpdateFone = jest.spyOn(respositoryFone, 'update').mockReturnValue(
            Promise.resolve(FoneEntity.create({ celular: true, codigo: '88', numero: '999151386' }))
        );
